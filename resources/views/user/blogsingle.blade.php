            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="news-img-box">
                        <img src="{{asset('user/img/slide-3.jpg')}}" alt="" class="img-fluid">
                    </div>
                </div>
                    ...
                    <div class="post-information">
                        <ul class="list-inline text-center color-a">
                            <li class="list-inline-item mr-2">
                                ...
                                <span class="color-text-a">Morgan Sharma</span>
                            </li>
                            <li class="list-inline-item mr-2">
                                <strong>Category: </strong>
                                <span class="color-text-a">House</span>
                            </li>
                            <li class="list-inline-item">
                                <strong>Date: </strong>
                                <span class="color-text-a">19 Apr. 2021</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="list-comments">
                            <li>
                                <div class="comment-avatar">
                                    <img src="{{asset('user/img/author-2.jpg')}}" alt="">
                                </div>
                            ...
                            <li class="comment-children">
                                <div class="comment-avatar">
                                    <img src="{{asset('user/img/author-1.jpg')}}" alt="">
                                </div>
                                <div class="comment-details">
